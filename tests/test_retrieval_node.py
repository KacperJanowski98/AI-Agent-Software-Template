...
from app.nodes_edges.nodes.retrieval_node import retrieve_node


@patch("app.nodes_edges.nodes.retrieval_node.create_retriever")
@patch("app.nodes_edges.nodes.retrieval_node.db")
@pytest.mark.asyncio
